...
public class CustomerServiceTest {
    ...
    void create_shouldReturnSavedCustomer() {
        CreateCustomerRequest request = new CreateCustomerRequest("Valid Name", "valid@email.com");
    ...
    @Test
    void findByName_null_shouldThrow() {
        assertThrows(DomainValidationException.class, () -> service.findByName(null));
        verifyNoInteractions(repository);
    }
